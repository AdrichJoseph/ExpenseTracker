        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiptBlobUrl = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalHistory_AspNetUsers_ActorId",
                        column: x => x.ActorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApprovalHistory_Expenses_ExpenseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalHistory_ActorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_Department_CategoryId_PeriodStart",
                table: "Budgets",
                columns: new[] { "Department", "CategoryId", "PeriodStart" },
                unique: true);
